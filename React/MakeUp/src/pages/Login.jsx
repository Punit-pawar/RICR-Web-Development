...
const Login = () => {
  ...
  return (
    <>
      <div className="text-center mt-30 w-75 ms-50 border-amber-200 border-2 h-70 rounded-3xl">
        <h1>Login</h1>

        <div className="container mt-4">
          <form onSubmit={handleSubmit} onReset={handleClearForm}>
            <div className="flex items-center mb-4">
              <label htmlFor="email" className="w-28 font-bold">
                Email :
              </label>
              <input
                type="email"
            ...
            <div className="flex items-center mb-4">
              <label htmlFor="password" className="w-28 font-bold">
                Password :
              </label>
              <input
                type="password"
