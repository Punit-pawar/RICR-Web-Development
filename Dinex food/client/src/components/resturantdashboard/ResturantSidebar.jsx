          ...
          <AnimatePresence>
            {isCollapsed && (
              <motion.div
                ...
                className="absolute left-[85px] bg-red-500 text-white text-[10px] font-bold uppercase tracking-widest px-3 py-2 rounded-xl whitespace-nowrap z-50 shadow-lg pointer-events-none"
              >
                Log Out
              </motion.div>
            )}
