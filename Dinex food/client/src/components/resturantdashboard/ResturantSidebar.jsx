  ...
  return (
    <aside className="fixed left-0 top-0 h-screen mt-18  z-50">
      <motion.div
        ...
        className="h-full relative flex flex-col bg-white/90 backdrop-blur-2xl border-r border-gray-100 shadow-[4px_0_40px_rgba(0,0,0,0.02)] overflow-hidden"
      >
        ...
        {/* ---------------- HEADER ---------------- */}
        <div className="flex items-center  h-24 px-5 border-b border-gray-100 relative z-10 shrink-0">
          <motion.button
        ...
        <motion.nav
          ...
          initial="hidden"
          animate="show"
          // Changed: Removed overflow-y-auto to disable internal scrolling
          className="flex-1 px-4 py-8 space-y-2 relative z-10 overflow-hidden"
        >
          {menuItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                {isActive && (
                  <motion.div
                    layoutId="activeRestaurantSidebarTab"
                ...
                <AnimatePresence>
                  {isCollapsed && (
                    <motion.div
                      ...
                      className="absolute left-[85px] bg-gray-900 text-white text-[10px] font-bold uppercase tracking-widest px-3 py-2 rounded-xl whitespace-nowrap z-50 shadow-lg pointer-events-none"
                    >
                      {item.label}
                    </motion.div>
                  )}
        ...
        {/* ---------------- FOOTER (LOGOUT) ---------------- */}
        <div className="p-4 border-t border-gray-100 relative z-10 shrink-0">
          <motion.button
