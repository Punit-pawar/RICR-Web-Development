            ...
            <form id="profile-form" onSubmit={handleSubmit}>
              ...
              <SettingsPanel title="Personal Information">
                <InputWrapper label="Full Name" id="fullName" required error={errors.fullName}>
                  <input type="text" id="fullName" name="fullName" value={formData.fullName} onChange={handleInputChange} className={inputStyles} placeholder="Enter your full name" />
                </InputWrapper>
                ...
                <InputWrapper label="Mobile Number" id="mobileNumber" required error={errors.mobileNumber}>
                  <input type="tel" id="mobileNumber" name="mobileNumber" value={formData.mobileNumber} onChange={handleInputChange} maxLength="10" className={inputStyles} placeholder="10-digit number" />
                </InputWrapper>
              ...
              <SettingsPanel title="Location & Address">
                <div className="md:col-span-2">
                  <InputWrapper label="Address" id="address">
                    <input type="text" id="address" name="address" value={formData.address} onChange={handleInputChange} className={inputStyles} placeholder="Enter your full address" />
                  </InputWrapper>
                </div>

                <InputWrapper label="City" id="city" required error={errors.city}>
                  <input type="text" id="city" name="city" value={formData.city} onChange={handleInputChange} className={inputStyles} placeholder="Enter city" />
                </InputWrapper>

                <InputWrapper label="PIN Code" id="pin" required error={errors.pin}>
                  <input type="text" id="pin" name="pin" value={formData.pin} onChange={handleInputChange} maxLength="6" className={inputStyles} placeholder="6-digit PIN" />
                </InputWrapper>

                <div className="md:col-span-2 flex flex-col sm:flex-row items-center justify-between p-4 bg-gray-50 border border-gray-200 rounded-md mt-2">
              ...
              <SettingsPanel title="Identification Documents">
                <InputWrapper label="Aadhaar (UIDAI)" id="uidai">
                  <input type="text" id="uidai" value={formData.documents.uidai} onChange={(e) => handleNestedChange("documents", "uidai", e.target.value)} className={inputStyles} placeholder="12-digit Aadhaar number" />
                </InputWrapper>
                
                <InputWrapper label="PAN Card" id="pan" error={errors.pan}>
                  <input type="text" id="pan" value={formData.documents.pan} onChange={(e) => handleNestedChange("documents", "pan", e.target.value)} maxLength="10" className={inputStyles} placeholder="ABCDE1234F" />
                </InputWrapper>
              </SettingsPanel>
              ...
              <SettingsPanel title="Payment Details">
                ...
                <InputWrapper label="Account Number" id="account_number">
                  <input type="text" id="account_number" value={formData.paymentDetails.account_number} onChange={(e) => handleNestedChange("paymentDetails", "account_number", e.target.value)} placeholder="Bank account number" className={inputStyles} />
                </InputWrapper>

                <InputWrapper label="IFSC Code" id="ifs_Code">
                  <input type="text" id="ifs_Code" value={formData.paymentDetails.ifs_Code} onChange={(e) => handleNestedChange("paymentDetails", "ifs_Code", e.target.value)} placeholder="IFSC code" className={inputStyles} />
                </InputWrapper>
              </SettingsPanel>
